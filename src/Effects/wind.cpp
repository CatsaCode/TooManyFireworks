...
namespace TooManyFireworks {
    ...
    // Set the wind strength, turbulence, and evolution properties of a single firework
    void UpdateWind(FireworkItemController* fireworkItemController) {
        ...
        auto SetScrollSpeed = il2cpp_utils::resolve_icall<void, ParticleSystem::NoiseModule*, ParticleSystem::MinMaxCurve*>("UnityEngine.ParticleSystem/NoiseModule::set_scrollSpeed_Injected");
        ...
        // Create scrollSpeed info object
        ParticleSystem::MinMaxCurve scrollSpeed;
        scrollSpeed.m_Mode = ParticleSystemCurveMode::Constant;
        scrollSpeed.m_ConstantMax = getModConfig().windEvolution.GetValue();
        ...
        SetScrollSpeed(&noise, &scrollSpeed);
    }
