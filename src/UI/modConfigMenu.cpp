...
namespace TooManyFireworks {
    ...
    void ModConfigMenuDidActivate(HMUI::ViewController* self, bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling) {
        ...
        BSML::SliderSetting* durationSlider = BSML::Lite::CreateSliderSetting(modMenuContainer, "Duration", 0.1f, getModConfig().duration.GetValue(), 0.1f, 10.0f, [](float value){getModConfig().duration.SetValue(value); ForceUpdateEachFirework(UpdateDuration);});
